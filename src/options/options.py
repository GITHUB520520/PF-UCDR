...
class Options:
    ...
    def __init__(self):
        ...
        parser.add_argument('-root', '--root_path', default="/root/autodl-tmp/PF_UCDR", type=str, help='file path of this repository')
        parser.add_argument('-data_path', '--dataset_path', default="/root/autodl-tmp/datasets", type=str,
                            help='file path of your datasets')
        parser.add_argument('-resume', '--resume_dict', default=None, type=str,
        ...
        parser.add_argument('-backbone', '--backbone', type=str,
                            choices=['deit_tiny_patch16_224', 'dino_vits16', 'dino_vitb16', 'deit_small_patch16_224',
                                     'deit_base_patch16_224'], default='deit_small_patch16_224', help='choose backbone')
        parser.add_argument('-CLS_NUM_TOKENS', '--CLS_NUM_TOKENS', default=300, type=int,
                            help='number of class visual prompt tokens')
        parser.add_argument('-DOM_NUM_TOKENS', '--DOM_NUM_TOKENS', default=5, type=int,
                            help='number of domain visual prompt tokens')
        parser.add_argument('-DOM_PROJECT', '--DOM_PROJECT', default=-1, type=int,
                            help='projection for domain visual prompt')
        parser.add_argument('-CLS_PROJECT', '--CLS_PROJECT', default=-1, type=int,
                            help='projection for class visual prompt')
        parser.add_argument('-VP_INITIATION', '--VP_INITIATION', default='random', type=str,
                            help='initiation for visual prompt')
        parser.add_argument('-tp_N_CTX', '--tp_N_CTX', default=16, type=int, help='initiation for visual prompt')
        parser.add_argument('-dropout', '--dropout', default=0.0, type=float, help='use debug model')
        parser.add_argument('-ratio_soft_dom', '--ratio_soft_dom', default=0.75, type=float,
                            help='domian softmax ratio')
        ...
        parser.add_argument('-prompt', '--prompt', default=1, type=int, help='prompt length')
        parser.add_argument('-GP_DOM_NUM_TOKENS', '--GP_DOM_NUM_TOKENS', default=1, type=int,
                            help='Prompt Template for Domain Prompt')
        parser.add_argument('-GP_CLS_NUM_TOKENS', '--GP_CLS_NUM_TOKENS', default=1, type=int,
                            help='Prompt Template for Semantic Prompt')
        ...
        # add phase images
        parser.add_argument('--num_cluster', default=7, type=int,
