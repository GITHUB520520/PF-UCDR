...
"""
compute_retrieval_metrics(sketchEmbeddings, sketchLabels, realEmbeddings, realLabels)
"""
...
def compute_retrieval_metrics1(acc_sk_em, acc_cls_sk, acc_im_em, acc_cls_im):
